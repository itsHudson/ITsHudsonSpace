...
我要全部都是 table format
我要写成像我之前英文 中文 上下的格式
然后 要有 example 如果 coding 很长 就不需要写在 table 里面
...
这是下一个 同时你也是要注明有哪些programming languages 有用到 和展示不同programming 的用法 要详细 不要敷衍我

├── 0004_Operators_and_Expressions/
│   ├── 0001_Fundamentals/
│   │   ├── 0001_Assignment
│   │   ├── 0002_Expressions
│   │   ├── 0003_Operator_Precedence
│   │   └── 0004_Associativity

│   ├── 0002_Types_of_Operators/
│   │   ├── 0001_Arithmetic
│   │   ├── 0002_Modulus
│   │   ├── 0003_Compound_Assignment
│   │   ├── 0004_Comparison
│   │   ├── 0005_Logical
│   │   ├── 0006_Increment_Decrement
│   │   ├── 0007_Bitwise
│   │   ├── 0008_Bit_Shift
│   │   ├── 0009_Unary_Operators
│   │   └── 0010_Ternary_Operator

│   └── 0003_Advanced/
│       ├── 0001_Boolean_Algebra
│       ├── 0002_Short_Circuit_Evaluation
│       ├── 0003_Relational_vs_Equality
│       └── 0004_Expressions_vs_Statements
...
嘿 CHATGPT
现在我要学 PYTHON 你会从A-Z 教我 不过之前 你要先给我 full details list 像这样
要很全面 不要写少少敷衍我
